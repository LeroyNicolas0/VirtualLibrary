...
<f:view>
    <html>
        <head>
            ...
            <title>New Administrateur</title>
        ...
        <body>
            ...
            <h1>New Administrateur</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{administrateur.validateCreate}" value="value"/>
                ...
                <br />
                <h:commandLink action="#{administrateur.create}" value="Create"/>
                <br />
                <br />
