...
<f:view>
    <html>
        <head>
            ...
            <title>PaysInterdit Detail</title>
        ...
        <body>
            ...
            <h1>PaysInterdit Detail</h1>
            <h:form>
                <h:panelGrid columns="2">
                    <h:outputText value="PaysId:"/>
                    <h:outputText value="#{paysInterdit.paysInterdit.paysId}" title="PaysId" />
                    <h:outputText value="Nom:"/>
                    <h:outputText value="#{paysInterdit.paysInterdit.nom}" title="Nom" />

                    <h:outputText value="DocumentCollection:" />
                    <h:panelGroup>
                        <h:outputText rendered="#{empty paysInterdit.paysInterdit.documentCollection}" value="(No Items)"/>
                        <h:dataTable value="#{paysInterdit.paysInterdit.documentCollection}" var="item" 
                                     border="0" cellpadding="2" cellspacing="0" rowClasses="jsfcrud_odd_row,jsfcrud_even_row" rules="all" style="border:solid 1px" 
                                     rendered="#{not empty paysInterdit.paysInterdit.documentCollection}">
                            <h:column>
                                <f:facet name="header">
                            ...
                            <h:column>
                                ...
                                <h:commandLink value="Show" action="#{document.detailSetup}">
                                    ...
                                    <f:param name="jsfcrud.relatedController" value="paysInterdit" />
                                    <f:param name="jsfcrud.relatedControllerType" value="jsf.PaysInterditController" />
                                </h:commandLink>
                                <h:outputText value=" "/>
                ...
                <br />
                <h:commandLink action="#{paysInterdit.remove}" value="Destroy">
                    <f:param name="jsfcrud.currentPaysInterdit" value="#{jsfcrud_class['jsf.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][paysInterdit.paysInterdit][paysInterdit.converter].jsfcrud_invoke}" />
                </h:commandLink>
                <br />
                <br />
                <h:commandLink action="#{paysInterdit.editSetup}" value="Edit">
                    <f:param name="jsfcrud.currentPaysInterdit" value="#{jsfcrud_class['jsf.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][paysInterdit.paysInterdit][paysInterdit.converter].jsfcrud_invoke}" />
                </h:commandLink>
                <br />
