...
<f:view>
    <html>
        <head>
            ...
            <title>New TypeParticipant</title>
        ...
        <body>
            ...
            <h1>New TypeParticipant</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{typeParticipant.validateCreate}" value="value"/>
                ...
                <br />
                <h:commandLink action="#{typeParticipant.create}" value="Create"/>
                <br />
                <br />
